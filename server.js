// server.js
// النسخة الكاملة بتصميم كلاسيكي نجدي هادئ + رفع ملفات PDF وCloudinary
...
const multer = require('multer'); // يجب تعريف multer قبل الاستخدام
...
// ========== Local storage for khutbah PDFs ==========
...
<p>منصة علمية موثوقة هدفها نشر الفتاوى والمقالات والخطب بالصوت والكتابة.</p></div>
</div></div></div>
...
app.post("/upload", uploadCloud.single("file"), (req, res) => {
  ...
  res.json({ success: true, url: req.file.path, id: req.file.filename });
});
